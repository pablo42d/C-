...
myRabbit.animalSound(); // Call the interface method
myRabbit.run(); // Call the interface method
/*
//Notes on Interfaces:
 ...
 * 
 */
DemoClass myDemo = new DemoClass(); // Create a DemoClass object
Console.WriteLine("Multiple Interfaces example: ");
